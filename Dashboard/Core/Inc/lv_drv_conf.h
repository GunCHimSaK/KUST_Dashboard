...
#  define SHARP_MIP_REV_BYTE(b) (b)        // ((uint8_t) __REV(__RBIT(b)))  /*Architecture / compiler dependent byte bits order reverse*/
#endif  /*USE_SHARP_MIP*/
...
#define LV_DRV_DISP_SPI_WR_ARRAY(adr, n) \
    HAL_SPI_Transmit(&hspi1, (uint8_t *)(adr), (uint16_t)(n), 1000)
