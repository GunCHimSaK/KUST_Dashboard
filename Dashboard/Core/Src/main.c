...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : STM_DIN0_Pin STM_DIN0A2_Pin STM_Button_6_Pin STM_Button_5_Pin
                           STM_Button_4_Pin STM_Button_2_Pin */
  GPIO_InitStruct.Pin = STM_DIN0_Pin|STM_DIN0A2_Pin|STM_Button_6_Pin|STM_Button_5_Pin
                          |STM_Button_4_Pin|STM_Button_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  /*Configure GPIO pins : STM_Button_1_Pin STM_Button_0_Pin STM_Button_7_Pin STM_Button_3_Pin */
  GPIO_InitStruct.Pin = STM_Button_1_Pin|STM_Button_0_Pin|STM_Button_7_Pin|STM_Button_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
